...
const PROVINCES: Row[] = [
  ...
  { name: "山西", reform: "old", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "2024 仍为老高考（文理分科，2025 起进入新高考首届）。本科一批/二批分批次，提前批/常规批分次第。" },
  { name: "内蒙古", reform: "old", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "吉林", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "福建", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考。首选物理/历史分轨。院校专业组志愿。厦大综合评价 + 福建省内多校公费师范 是本省特色。" },
  { name: "江西", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "河南", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "广西", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2024 首届）。少数民族加分政策（壮族/瑶族等）。广西大学是省内唯一 211。民族班/预科班招生量较大。" },
  { name: "海南", reform: "3+3", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
  ...
  { name: "贵州", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2024 首届）。首选物理/历史分轨。国家专项计划是贵州特色（脱贫县/集中连片特困区）。贵州大学是省内唯一 211。" },
  { name: "云南", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2025 首届）。首选物理/历史 + 再选 2 科。少数民族加分 + 民族班/预科班。云大/昆工是省内主要去向。" },
  { name: "西藏", reform: "old", plan: "live", scores: "live", rank: "none", actual: "live", employment: "live",
  ...
  { name: "青海", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2025 首届）。少数民族加分政策（藏族/回族/土族/撒拉族等）。民族班/预科班招生量大。青大医学院藏族民族班是本地医学主路径。" },
  { name: "宁夏", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
    rules: "3+1+2 新高考（2025 首届）。少数民族加分（回族）。宁大/北方民大 是省内主要去向。" },
  { name: "新疆", reform: "3+1+2", plan: "live", scores: "live", rank: "live", actual: "live", employment: "live",
